...
function mostrarInstrucoes() {
    ...
    textoInstrucoes.textContent = "Este quiz contém 20 questões desafiadoras sobre regras de trânsito, com foco em canalizações e condutas. Teste seus conhecimentos e se divirta enquanto aprende! Concentre-se para obter uma boa pontuação e, se precisar, jogue novamente quantas vezes quiser para melhorar seu desempenho.";
...
const questoes = [
    ...
    },
    {
        ...
        },
        {
                ...
                imagem: "Imagens-EPTRAN/imagem 8.jpg",
                respostas: [
