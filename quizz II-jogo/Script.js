...
musicaFundo.loop = true; // Configurar para repetir automaticamente
musicaFundo.volume = 0.5; // Ajustar volume, se necessário

// Função para iniciar o jogo e tocar o áudio de fundo
function iniciarJogo() {
    musicaFundo.play(); // Tocar a música de fundo
    // Outros códigos para iniciar o jogo
}
